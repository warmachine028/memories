...
import { Button, ButtonGroup, Paper, TextField, Typography, Avatar, Grid2 as Grid, Stack, Divider, FormControl, FormHelperText } from '@mui/material'
...
const SignUp = () => {
	...
	const attemptSignUp = async (formData) => {
		...
		try {
			...
			setErrors({ ...errors, clerkError: error.message })
		}
	}
